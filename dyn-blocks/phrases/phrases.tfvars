upload_content = [
  ...
  { content = "YS3, (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "YS4, (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
